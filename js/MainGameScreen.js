...
gameControl.MainGameScreen.prototype = {	
    create: function () {
        ...
        slowDownButton = this.input.keyboard.addKey(Phaser.Keyboard.SHIFT);
        stopButton = this.input.keyboard.addKey(Phaser.Keyboard.CONTROL);
    },	
